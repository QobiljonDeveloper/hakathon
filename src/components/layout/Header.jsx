...
import { FiMenu, FiSend } from "react-icons/fi"; // Import the Telegram icon
import logo from "../../assets/LogoShaxar.jpg";
import scrolledLogo from "../../assets/LogoShaxar.jpg";
...
const HeaderComponents = () => {
  ...
  // Show the Telegram button only on the "/myhome" route
  const showTelegramButton = location.pathname === "/myhome";
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div className="relative flex gap-2 items-center">
          ...
          <div className="flex items-center gap-2">
            {showTelegramButton && (
              <button className="bg-gray-800 text-white px-3 py-1 rounded hover:bg-gray-700 transition duration-300">
            ...
            <select
              ...
              value={i18n.language}
              className="bg-gray-800 text-white px-3  rounded hover:bg-gray-700 transition duration-300 py-2"
            >
